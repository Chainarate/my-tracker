...
class SharedFeedsConfig:
    ...
    feeds: Tuple[str, ...] = (
        ...
        # NOTE: The Telegraph blocks RSS scraping at Akamai edge (HTTP 403
        # even with browser User-Agent). Would need Playwright/headless
        # browser → out of scope for zero-cost stack.
    )
